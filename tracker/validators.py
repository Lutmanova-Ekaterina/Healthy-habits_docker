...
class Validate_Pleasant:
    ...
    def __call__(self, value, serializer_field):
        hobit_pk = serializer_field.initial_data.get('connection')  # чтобы валидатору передавалось поле сериализатора, с которым он используется, в качестве дополнительного контекста.
