...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\PyCharm Projects\Kursovoy_Project_Healthy_habits\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\PyCharm Projects\Kursovoy_Project_Healthy_habits\venv\Scripts\deactivate.nu'
